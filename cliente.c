// Basicamente una copia del archivo "cliente_copia.c" para que muestre el estado de las
// propiedades del device en el server.
...
static bool print_verbose = true;
...
static indigo_device my_device = {
    "CCD sim",
    false,
    NULL,
    INDIGO_OK,
...
int main(int argc, const char * argv[]) {
    ...
    //indigo_attach_device(&my_device);
    ...
    indigo_usleep(13*ONE_SECOND_DELAY);
